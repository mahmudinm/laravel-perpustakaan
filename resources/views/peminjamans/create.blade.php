    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Buat Peminjaman Baru</div>

                <div class="panel-body">
                    {!! Form::open(['method' => 'POST', 'route' => 'peminjamans.store']) !!}
                        
                        <div class="form-group{{ $errors->has('books') ? ' has-error' : '' }}">
                            {!! Form::label('books', 'Books') !!}
                            {!! Form::select('books', $books, null, ['id' => 'books', 'class' => 'form-control', 'required' => 'required']) !!}
